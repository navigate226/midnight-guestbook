...
import { GuestbookPrivateStateId } from '@guestbook/guestbook-api';
...
export class TestnetLocalConfig implements Config {
  privateStateStoreName = GuestbookPrivateStateId;
  logDir = path.resolve(currentDir, '..', 'logs', 'testnet-local', `${new Date().toISOString()}.log`);
  zkConfigPath = path.resolve(currentDir, '..', '..', 'contract', 'dist', 'managed', 'guestbook');
